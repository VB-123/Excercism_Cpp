...
Critical_Temeperature = 800
Critical_neutron_number = 500
Critical_condition = 500000
def is_criticality_balanced(temperature, neutrons_emitted):
    ...
    if temperature >= Critical_Temeperature  or neutrons_emitted <= Critical_neutron_number:
        return False
    return Critical_product < Critical_condition
