...
namespace estate_executor {
    ...
    int assemble_code(){
        int assembled_code_blue {zhang::blue::code_fragment() + khan::blue::code_fragment() + garcia::blue::code_fragment()};
        int assembled_code_red {zhang::red::code_fragment() + khan::red::code_fragment() + garcia::red::code_fragment()};
        return assembled_code_blue * assembled_code_red;
    }
}